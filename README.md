...
当前项目已经包含角色创建、升级、施法资源、装备/背包、战斗结算、怪物图鉴、掉落与数据库持久化等功能，功能会慢慢补充
...
- 战斗系统：支持角色参战、怪物检索、先攻排序、攻击结算、状态效果、经验分配与掉落分配。
...
- macOS / Windows / Linux
- SQLite JDBC 驱动：
  [lib/sqlite-jdbc-3.51.3.0.jar](/Users/hatys/IdeaProjects/DMDHelper1/lib/sqlite-jdbc-3.51.3.0.jar)

## 在 IDE 中运行

入口类：

- [Main.java](/Users/hatys/IdeaProjects/DMDHelper1/src/Main.java)

运行前确认：

- 项目 `classpath` 已包含 `sqlite-jdbc-3.51.3.0.jar`
- 资源文件已包含应用图标：
  [app_icon.png](/Users/hatys/IdeaProjects/DMDHelper1/src/com/DMDHelper/assets/app_icon.png)
...
- [app_icon.ico](/Users/hatys/IdeaProjects/DMDHelper1/src/com/DMDHelper/assets/app_icon.ico)

macOS 打包时建议使用：

- [app_icon.icns](/Users/hatys/IdeaProjects/DMDHelper1/src/com/DMDHelper/assets/app_icon.icns)
